"""Brazilian Credit Card Spending file for ensuring the package is executable
as `brazilian-credit-card-spending` and `python -m brazilian_credit_card_spending`
"""
import importlib
